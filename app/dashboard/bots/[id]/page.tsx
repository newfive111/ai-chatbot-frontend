              ...
              <div>
                ...
                <div className="flex gap-2">
                  <code className="flex-1 bg-gray-800 px-4 py-3 rounded-lg text-green-400 text-xs font-mono overflow-x-auto">
                    {`https://graceful-patience-production-0170.up.railway.app/line/webhook/${id}`}
                  </code>
                  <button
                    onClick={() => {
                      navigator.clipboard.writeText(`https://graceful-patience-production-0170.up.railway.app/line/webhook/${id}`);
